...
public class BEMCheckBox: UIControl, CAAnimationDelegate {
    ...
    * @discussion The delegate must adopt the \p BEMCheckBoxDelegate protocol. The delegate is not retained.
    ...
    private func addOnAnimation() {
        ...
        case .fill:
            if let wiggle = animationManager.fillAnimation(withBounces: 1, amplitude: 0.18, reverse: false) {
        ...
        case .bounce:
            ...
            if let wiggle = animationManager.fillAnimation(withBounces: 1, amplitude: amplitude, reverse: false) {
    ...
    private func addOffAnimation() {
        ...
        case .fill:
            if let wiggle = animationManager.fillAnimation(withBounces: 1, amplitude: 0.18, reverse: true)
            {
        ...
        case .bounce:
            let amplitude: CGFloat = (boxType == .square) ? 0.20 : 0.35
            if let wiggle = animationManager.fillAnimation(withBounces: 1, amplitude: amplitude, reverse: true),
